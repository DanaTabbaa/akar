...
@Component({
  selector: 'app-opportunity-details2',
  templateUrl: './opportunity-details2.component.html',
  styleUrls: ['./opportunity-details2.component.scss']
})
export class OpportunityDetails2Component implements OnInit ,OnChanges{
