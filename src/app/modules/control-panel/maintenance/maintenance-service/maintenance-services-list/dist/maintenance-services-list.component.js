...
exports.MaintenanceServicesListComponent = void 0;
...
var maintenanceservices_actions_1 = require("src/app/core/stores/actions/maintenanceservices.actions");
var PAGEID = 18; // from pages table in database seeding table
var MaintenanceServicesListComponent = /** @class */ (function () {
    //#endregion
    //#region Constructor
    function MaintenanceServicesListComponent(maintenanceServicesService, router, sharedServices, rolesPerimssionsService, alertsService, modalService, translate, store) {
        ...
        this.store = store;
        this.addUrl = '/control-panel/maintenance/add-maintenance-service';
        this.updateUrl = '/control-panel/maintenance/update-maintenance-service/';
        this.listUrl = '/control-panel/maintenance/maintenance-services-list';
    ...
    //#endregion
    //#region ngOnInit
    MaintenanceServicesListComponent.prototype.ngOnInit = function () {
    ...
    //#endregion
    //#region ngOnDestroy
    MaintenanceServicesListComponent.prototype.ngOnDestroy = function () {
    ...
    MaintenanceServicesListComponent.prototype.getPagePermissions = function (pageId) {
        var _this = this;
    ...
    MaintenanceServicesListComponent.prototype.getMaintenanceServices = function () {
        var _this = this;
        var promise = new Promise(function (resolve, reject) {
    ...
    MaintenanceServicesListComponent.prototype["delete"] = function (id) {
    ...
    //navigatetoupdate
    MaintenanceServicesListComponent.prototype.edit = function (id) {
        this.router.navigate(['/control-panel/maintenance/update-maintenance-service', id]);
    };
    //#endregion
    //#region Helper Functions
    MaintenanceServicesListComponent.prototype.showResponseMessage = function (responseStatus, alertType, message) {
    ...
    MaintenanceServicesListComponent.prototype.showConfirmDeleteMessage = function (id) {
        var _this = this;
        ...
        modalRef.result.then(function (rs) {
            if (rs == 'Confirm') {
                var deletedItem = _this.maintenanceServices.find(function (x) { return x.id == id; });
                _this.maintenanceServicesService["delete"](id).subscribe(function (resonse) {
                    _this.getMaintenanceServices();
                    if (resonse.success == true) {
                        _this.store.dispatch(maintenanceservices_actions_1.MaintenanceServicesActions.actions["delete"]({
    ...
    MaintenanceServicesListComponent.prototype.defineGridColumn = function () {
        var _this = this;
        this.sharedServices.getLanguage().subscribe(function (res) {
            ...
            _this.columnNames = [
                ...
                {
                    title: _this.lang == 'ar' ? ' أسم الخدمة باللغة العربية' : 'Service Name In Arabic',
                    field: 'serviceNameAr'
                },
                {
                    title: _this.lang == 'ar' ? ' أسم الخدمة باللغة الانجليزية' : 'Service Name In English',
                    field: 'serviceNameEn'
                },
                _this.lang == "ar" ? {
                    title: "حذف",
    ...
    MaintenanceServicesListComponent.prototype.editFormatIcon = function () {
        return "<i class=' fa fa-edit'></i>";
    };
    ;
    MaintenanceServicesListComponent.prototype.deleteFormatIcon = function () {
        return "<i class=' fa fa-trash'></i>";
    };
    ;
    MaintenanceServicesListComponent.prototype.CheckBoxFormatIcon = function () {
        return "<input id='yourID' type='checkbox' />";
    };
    ;
    MaintenanceServicesListComponent.prototype.onSearchTextChange = function (searchTxt) {
        this.searchFilters = [
            [
    ...
    MaintenanceServicesListComponent.prototype.openAddMaintenanceServices = function () { };
    MaintenanceServicesListComponent.prototype.onMenuActionSelected = function (event) {
        if (event != null) {
    ...
    MaintenanceServicesListComponent.prototype.listenToClickedButton = function () {
        var _this = this;
    ...
    MaintenanceServicesListComponent = __decorate([
        core_1.Component({
    ...
    return MaintenanceServicesListComponent;
}());
exports.MaintenanceServicesListComponent = MaintenanceServicesListComponent;
