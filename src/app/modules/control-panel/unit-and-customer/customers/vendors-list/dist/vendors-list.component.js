...
exports.VendorsListComponent = void 0;
...
var vendor_actions_1 = require("src/app/core/stores/actions/vendor.actions");
var PAGEID = 11; // from pages table in database seeding table
var VendorsListComponent = /** @class */ (function () {
    //#endregion
    //#region Constructor
    function VendorsListComponent(vendorsService, sharedServices, alertsService, modalService, translate, spinner, rolesPerimssionsService, store, router) {
        ...
        this.vendors = [];
        this.addUrl = '/control-panel/definitions/add-vendor';
        this.updateUrl = '/control-panel/definitions/update-vendor/';
        this.listUrl = '/control-panel/definitions/vendors-list';
    ...
    //#endregion
    //#region ngOnDestroy
    VendorsListComponent.prototype.ngOnDestroy = function () {
    ...
    VendorsListComponent.prototype.getPagePermissions = function (pageId) {
        var _this = this;
    ...
    VendorsListComponent.prototype.getVendors = function () {
        var _this = this;
        var promise = new Promise(function (resolve, reject) {
            _this.vendorsService.getAll("GetAll").subscribe({
                next: function (res) {
                    _this.vendors = res.data.map(function (res) {
                        return res;
                    });
                    resolve();
                },
    ...
    VendorsListComponent.prototype["delete"] = function (id) {
    ...
    VendorsListComponent.prototype.edit = function (id) {
    ...
    VendorsListComponent.prototype.showConfirmDeleteMessage = function (id) {
        var _this = this;
        ...
        modalRef.result.then(function (rs) {
            if (rs == 'Confirm') {
                _this.spinner.show();
                _this.vendorsService.deleteWithUrl("Delete?id=" + id).subscribe(function (resonse) {
                    var deletedItem = _this.vendors.find(function (x) { return x.id == id; });
                    _this.getVendors();
                    if (resonse.success == true) {
                        _this.store.dispatch(vendor_actions_1.VendorActions.actions["delete"]({
    ...
    VendorsListComponent.prototype.showResponseMessage = function (responseStatus, alertType, message) {
    ...
    VendorsListComponent.prototype.defineGridColumn = function () {
        var _this = this;
    ...
    VendorsListComponent.prototype.editFormatIcon = function () {
        return "<i class=' fa fa-edit'></i>";
    };
    ;
    VendorsListComponent.prototype.deleteFormatIcon = function () {
        return "<i class='fa fa-trash'></i>";
    };
    ;
    VendorsListComponent.prototype.CheckBoxFormatIcon = function () {
        return "<input id='yourID' type='checkbox' />";
    };
    ;
    VendorsListComponent.prototype.onSearchTextChange = function (searchTxt) {
        this.searchFilters = [
            [
    ...
    VendorsListComponent.prototype.openAddVendors = function () { };
    VendorsListComponent.prototype.onMenuActionSelected = function (event) {
        if (event != null) {
    ...
    VendorsListComponent.prototype.listenToClickedButton = function () {
        var _this = this;
...
exports.VendorsListComponent = VendorsListComponent;
