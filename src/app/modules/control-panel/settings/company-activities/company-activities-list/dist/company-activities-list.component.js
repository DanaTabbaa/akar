...
exports.CompanyActivitiesListComponent = void 0;
...
var PAGEID = 41; // from pages table in database seeding table
var CompanyActivitiesListComponent = /** @class */ (function () {
    function CompanyActivitiesListComponent(router, modalService, sharedServices, rolesPerimssionsService, alertsService, translate, spinner, CompaniesActivitiesService) {
        this.router = router;
        ...
        this.CompaniesActivitiesService = CompaniesActivitiesService;
        this.companiesActivities = [];
        this.addUrl = '/control-panel/settings/add-company-activity';
        this.updateUrl = '/control-panel/settings/update-company-activity/';
        this.listUrl = '/control-panel/settings/company-activities-list';
    ...
    CompanyActivitiesListComponent.prototype.ngOnInit = function () {
    ...
    CompanyActivitiesListComponent.prototype.getPagePermissions = function (pageId) {
        var _this = this;
    ...
    //#endregion
    CompanyActivitiesListComponent.prototype.getCompanyActivities = function () {
        var _this = this;
        var promise = new Promise(function (resolve, reject) {
            _this.CompaniesActivitiesService.getAll("GetAll").subscribe({
                next: function (res) {
                    _this.companiesActivities = res.data.map(function (res) {
                        return res;
                    });
                    resolve();
                    //(("res", res);
    ...
    CompanyActivitiesListComponent.prototype["delete"] = function (id) {
    ...
    //navigatetoupdate
    CompanyActivitiesListComponent.prototype.edit = function (id) {
    ...
    CompanyActivitiesListComponent.prototype.navigate = function (urlroute) {
        this.router.navigate([urlroute]);
    };
    //#region ngOnDestory
    CompanyActivitiesListComponent.prototype.ngOnDestroy = function () {
    ...
    CompanyActivitiesListComponent.prototype.defineGridColumn = function () {
        var _this = this;
    ...
    CompanyActivitiesListComponent.prototype.editFormatIcon = function () {
        return "<i class=' fa fa-edit'></i>";
    };
    ;
    CompanyActivitiesListComponent.prototype.deleteFormatIcon = function () {
        return "<i class=' fa fa-trash'></i>";
    };
    ;
    CompanyActivitiesListComponent.prototype.CheckBoxFormatIcon = function () {
        return "<input id='yourID' type='checkbox' />";
    };
    ;
    CompanyActivitiesListComponent.prototype.onSearchTextChange = function (searchTxt) {
        this.searchFilters = [
            [
    ...
    CompanyActivitiesListComponent.prototype.openCompaniesActivities = function () { };
    CompanyActivitiesListComponent.prototype.onMenuActionSelected = function (event) {
        if (event != null) {
    ...
    CompanyActivitiesListComponent.prototype.showResponseMessage = function (responseStatus, alertType, message) {
    ...
    CompanyActivitiesListComponent.prototype.showConfirmDeleteMessage = function (id) {
        var _this = this;
        ...
        modalRef.result.then(function (rs) {
            ...
            if (rs == 'Confirm') {
                _this.spinner.show();
                _this.CompaniesActivitiesService.deleteWithUrl("Delete?id=" + id).subscribe(function (resonse) {
                    //(('delet response', resonse);
                    _this.getCompanyActivities();
    ...
    CompanyActivitiesListComponent.prototype.listenToClickedButton = function () {
        var _this = this;
    ...
    CompanyActivitiesListComponent = __decorate([
        core_1.Component({
    ...
    return CompanyActivitiesListComponent;
}());
exports.CompanyActivitiesListComponent = CompanyActivitiesListComponent;
