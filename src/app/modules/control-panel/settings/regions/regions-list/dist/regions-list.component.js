...
exports.RegionsListComponent = void 0;
...
var region_actions_1 = require("src/app/core/stores/actions/region.actions");
var PAGEID = 38; // from pages table in database seeding table
var RegionsListComponent = /** @class */ (function () {
    function RegionsListComponent(router, modalService, sharedServices, alertsService, rolesPerimssionsService, translate, spinner, store, regionsService) {
        this.router = router;
        ...
        this.regions = [];
        this.addUrl = '/control-panel/settings/add-region';
        this.updateUrl = '/control-panel/settings/update-region/';
        this.listUrl = '/control-panel/settings/regions-list';
    ...
    //#region ngOnDestory
    RegionsListComponent.prototype.ngOnDestroy = function () {
    ...
    RegionsListComponent.prototype.getPagePermissions = function (pageId) {
        var _this = this;
    ...
    //#endregion
    RegionsListComponent.prototype.getRegions = function () {
        var _this = this;
        var promise = new Promise(function (resolve, reject) {
    ...
    RegionsListComponent.prototype["delete"] = function (id) {
    ...
    RegionsListComponent.prototype.goToAdd = function (typeOfComponent) {
        this.router.navigate(['/control-panel/settings/add-region'], { queryParams: { typeOfComponent: typeOfComponent } });
    };
    //navigatetoupdate
    RegionsListComponent.prototype.edit = function (id) {
    ...
    RegionsListComponent.prototype.navigate = function (urlroute) {
        this.router.navigate([urlroute]);
    };
    RegionsListComponent.prototype.defineGridColumn = function () {
        var _this = this;
    ...
    RegionsListComponent.prototype.editFormatIcon = function () {
        return "<i class='fa fa-edit'></i>";
    };
    ;
    RegionsListComponent.prototype.deleteFormatIcon = function () {
        return "<i class=' fa fa-trash'></i>";
    };
    ;
    RegionsListComponent.prototype.CheckBoxFormatIcon = function () {
        return "<input id='yourID' type='checkbox' />";
    };
    ;
    RegionsListComponent.prototype.onSearchTextChange = function (searchTxt) {
        this.searchFilters = [
            [
    ...
    RegionsListComponent.prototype.openRegions = function () { };
    RegionsListComponent.prototype.onMenuActionSelected = function (event) {
        if (event != null) {
    ...
    RegionsListComponent.prototype.showResponseMessage = function (responseStatus, alertType, message) {
    ...
    RegionsListComponent.prototype.showConfirmDeleteMessage = function (id) {
        var _this = this;
        ...
        modalRef.result.then(function (rs) {
            if (rs == 'Confirm') {
                _this.spinner.show();
                var deletedItem = _this.regions.find(function (x) { return x.id == id; });
                _this.regionsService.deleteWithUrl("Delete?id=" + id).subscribe(function (resonse) {
                    _this.getRegions();
                    if (resonse.success == true) {
                        _this.store.dispatch(region_actions_1.RegionActions.actions["delete"]({
                            data: JSON.parse(JSON.stringify(__assign({}, deletedItem)))
                        }));
                        _this.showResponseMessage(resonse.success, enums_1.AlertTypes.warning, _this.translate.transform("messages.delete-success"));
                    }
    ...
    RegionsListComponent.prototype.listenToClickedButton = function () {
        var _this = this;
...
exports.RegionsListComponent = RegionsListComponent;
