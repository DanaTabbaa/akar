...
const PAGEID = 55;
@Component({
  selector: 'app-rents-dues',
  templateUrl: './rents-dues.component.html',
  styleUrls: ['./rents-dues.component.scss']
})
export class RentsDuesComponent implements OnInit, OnDestroy {
  //#region constructor
  ...
  toolbarPathData: ToolbarPath = {
    ...
    addPath: '',
    updatePath: '',
    componentList: "sidebar.rents-dues-report",
    componentAdd: '',
  };
  //#endregion
  ...
  gotoViewer() {
    ...
    modalRef.componentInstance.oldUrl = "/control-panel/reports/rents-dues";



  }
  cancelDefaultReportStatus() {
    this.reportService.cancelDefaultReport(4, 14).subscribe(resonse => {
