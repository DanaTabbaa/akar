...
const PAGEID = 56;
@Component({
  selector: 'app-contracts-detection',
  templateUrl: './contracts-detection.component.html',
  styleUrls: ['./contracts-detection.component.scss']
})
export class ContractsDetectionComponent implements OnInit, OnDestroy {
  //#region constructor
  ...
  toolbarPathData: ToolbarPath = {
    ...
    addPath: '',
    updatePath: '',
    componentList: "sidebar.contracts-report",
    componentAdd: '',
  };
  //#endregion
  ...
  gotoViewer() {
    ...
    modalRef.componentInstance.reportTypeID = 15;
    modalRef.componentInstance.oldUrl = "/control-panel/reports/contracts-detection";

  }
  cancelDefaultReportStatus() {
    this.reportService.cancelDefaultReport(4, 15).subscribe(resonse => {
