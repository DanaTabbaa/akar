...
const PAGEID = 57;
@Component({
  selector: 'app-vendors-commissions',
  templateUrl: './vendors-commissions.component.html',
  styleUrls: ['./vendors-commissions.component.scss']
})
export class VendorsCommissionsComponent implements OnInit, OnDestroy {
  //#region constructor
  ...
  toolbarPathData: ToolbarPath = {
    ...
    addPath: '',
    updatePath: '',
    componentList: "sidebar.vendors-commissions",
    componentAdd: '',
  };
  //#endregion
  ...
  //#endregion
  gotoViewer() {
    if (this.rentContractId == null || this.rentContractId == undefined) {
      this.rentContractId = 0;
    }

    let reportParams: string =
      "reportParameter=contractId!" + this.rentContractId +
    ...
    modalRef.componentInstance.oldUrl = "/control-panel/reports/vendors-commissions";


  }
  cancelDefaultReportStatus() {
    this.reportService.cancelDefaultReport(4, 16).subscribe(resonse => {
  ...
  OnFilter(e: {
    ...
    //(("REPORT ONFILTER ",e);
    this.rentContractId = e.rentContractId
