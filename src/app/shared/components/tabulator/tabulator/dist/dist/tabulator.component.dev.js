...
var TabulatorComponent =
    /** @class */
    function() {
        function TabulatorComponent(renderer, store) {
            var _this = this;
            ...
            this.onAddGroup = new core_1.EventEmitter(); // @Input() showAddGroup:boolean = false;
            ...
            this.headerMenu = function() {
                ...
                var _loop_1 = function _loop_1(column) {
                    ...
                    icon.classList.add(column.isVisible() ? "fa-check-square" : "fa-square"); //build label

                    var label = document.createElement("span");
                    var title = document.createElement("span"); ////((column, column.getDefinition().title)

                    title.textContent = " " + column.getDefinition().title;
                    label.appendChild(icon);
                    label.appendChild(title); //create menu item

                    menu.push({
                        label: label,
                        action: function action(e) {
                            //prevent menu closing
                            e.stopPropagation(); //toggle current column visibility

                            column.toggle(); //change menu item icon
        ...
        TabulatorComponent.prototype.ngOnInit = function() { //this.listenToRedraw();
        };
        ...
        TabulatorComponent.prototype.drawTable = function() {
            ...
            this.tabular = new Tabulator(this.tab, {
                ...
                cellDblClick: function cellDblClick(e, cell) {
                ...
                rowContextMenu: function rowContextMenu(row, e) {
                    return _this.getContextMenu(row, e, _this.showMenuOptions, _this, _this.componentName);
                },
                groupHeader: function groupHeader(value, count, data, group) {
                    return value + "<span style='color:#d00; margin-left:10px;'>(" + count + " item)</span>";
                },
                tooltips: function tooltips(cell) {
        ...
        TabulatorComponent.prototype.showSearchButton = function() {
            if (!this.searchTxt) { // this.renderer.setStyle(this.searchInput?.nativeElement, "width", "0px");
        ...
        TabulatorComponent.prototype.getContextMenu = function(row, e, menuOptions, scope, componentName) {
            ...
            var menu = []; ////((component.getData())

            if (menuOptions.showEdit) {
                menu.push(scope.getContextMenuItem(row, componentName, "Edit", "../../../assets/sniper/images/dropdown_edit.svg"));
            }

            if (menuOptions.showActivate) {
                menu.push(scope.getContextMenuItem(row, componentName, "Activate", "../../../assets/sniper/images/check_icon.svg"));
            }

            if (menuOptions.showDelete) {
                menu.push(scope.getContextMenuItem(row, componentName, "Delete", "../../../assets/sniper/images/delete_blue.svg"));
            }
            ...
            if (menuOptions.showUserGroup) {
                menu.push(scope.getContextMenuItem(row, componentName, "UserGroups", "../../../assets/sniper/images/dropdown_folder.svg"));
            }

            if (menuOptions.showUserDevice) {
                menu.push(scope.getContextMenuItem(row, componentName, "UserDevices", "../../../assets/sniper/images/dropdown_device.svg"));
            }
            ...
            if (menuOptions.showUserNotification) {
                menu.push(scope.getContextMenuItem(row, componentName, "UserNotifications", "../../../assets/sniper/images/dropdown_notification.svg"));
            }
            ...
            if (menuOptions.showDetermineTheTechnician) {
                menu.push(scope.getContextMenuItem(row, componentName, "DetermineTheTechnician", "../../../assets/sniper/images/dropdown_edit.svg"));
            }

            if (menuOptions.showRequestDetails) {
                menu.push(scope.getContextMenuItem(row, componentName, "RequestDetails", "../../../assets/sniper/images/dropdown_edit.svg"));
            }
            ...
            if (maintenanceRequestState != null) {
                if (maintenanceRequestState == 3 || maintenanceRequestState == 4 || maintenanceRequestState == 5 || maintenanceRequestState == 6) {
                    if (menuOptions.showProductReceipt) {
                        menu.push(scope.getContextMenuItem(row, componentName, "ProductReceipt", "../../../assets/sniper/images/dropdown_edit.svg"));
                    }
                }

                if (maintenanceRequestState == 3 || maintenanceRequestState == 4) {
                    if (menuOptions.showPriceRequest) {
                        menu.push(scope.getContextMenuItem(row, componentName, "PriceRequest", "../../../assets/sniper/images/dropdown_edit.svg"));
                    }
                }

                if (maintenanceRequestState != 8) {
                    if (menuOptions.showCloseRequest) {
                        menu.push(scope.getContextMenuItem(row, componentName, "CloseRequest", "../../../assets/sniper/images/dropdown_edit.svg"));
                    }
                }
            }
            ...
            if (contractStatus != null) {
                ...
                if (contractStatus == 0 || contractStatus == 5) {
                    if (menuOptions.showIssueContract) {
                        menu.push(scope.getContextMenuItem(row, componentName, "IssueContract", "../../../assets/sniper/images/dropdown_edit.svg"));
                    }
                }

                if (contractStatus == 8 && row._row.data.isRenew != true) {
                    if (menuOptions.showRenewContract) {
                        menu.push(scope.getContextMenuItem(row, componentName, "RenewContract", "../../../assets/sniper/images/dropdown_edit.svg"));
                    }
                }

                if (contractStatus != 7) {
                    if (menuOptions.showSettlementContract) {
                        menu.push(scope.getContextMenuItem(row, componentName, "SettlementContract", "../../../assets/sniper/images/dropdown_edit.svg"));
                    }
                }
            }

            if (menuOptions.showPrint) {
                menu.push(scope.getContextMenuItem(row, componentName, "Print", "../../../assets/sniper/images/dropdown_edit.svg"));
            }
        ...
        TabulatorComponent.prototype.getContextMenuItem = function(row, componentName, actionName, iconUrl) {
            var _this = this;
        ...
        TabulatorComponent.prototype.onShowHideColumn = function(column, visible) {
            if (this.tabular) { ////((this.tabular.getColumns());
        ...
        TabulatorComponent.prototype.setHeaderContextMenu = function() {
            ...
            if (this.columnNames) {
                this.columnNames.forEach(function(col) {
                    col["headerContextMenu"] = function(c) {
                        return _this.headerContextMenuSetting(c, _this);
                    };
                });
            }
        };
        ...
        TabulatorComponent.prototype.headerContextMenuSetting = function(column, scope) {
            var headerContextMenu = [{
                ...
                action: function action(e, column) {
                    ...
                    if (colDefination) {
                        if (!scope.groupByList.find(function(a) {
                                return a == colDefination.field;
                            })) {
                ...
                action: function action(e, column) {
                    ...
                    if (colDefination) {
                        ...
                        var unGroupFieldName_1 = scope.groupByList.find(function(a) {
                            return a == colDefination.field;
                        });

                        if (unGroupFieldName_1) {
                            var index = scope.groupByList.findIndex(function(a) {
                                return a == unGroupFieldName_1;
                            });
                ...
                action: function action(e, column) {
                    ...
                    if (colDefination) {
                        ...
                        if (scope.sortByList) {
                            ...
                            var sortBy = scope.sortByList.find(function(x) {
                                return x.column == colDefination.field;
                            });
        ...
        TabulatorComponent.prototype.exportHtml = function() {
            this.tabular.download("html", "data.html", {
                style: true
            });
        };
        ...
        TabulatorComponent.prototype.exportExcel = function() {
            this.tabular.download("xlsx", "data.xlsx", {
                sheetName: "My Data"
            });
        };
        ...
        TabulatorComponent.prototype.translateColumns = function(columns, componentName) {
            for (var i = 0; i < this.columnNames.length; i++) {
                var col = this.columnNames[i]; //col.title = this.translate.transform((componentName + "." + col.field));
            }
        };
        ...
        TabulatorComponent.prototype.afterSort = function(sorters, rows) { /////((sorters, rows);
        };

        TabulatorComponent.prototype.removeSortItem = function() {}; // lisetnToActivePanel() {
        ...
        TabulatorComponent.prototype.groupByItems = function(e) {
            ...
            this.groupByList = newGroupByList.filter(function(x) {
                return true;
            });
            this.tabular.setGroupBy(this.groupByList);
        };
        ...
        TabulatorComponent.prototype.showHideArraneColums = function(e) {
            var _this = this; //Update current columns setting
            ////((this.columnNames);


            var newColSetting = [];
            e.forEach(function(nCol) {
                var currentCol = _this.columnNames.find(function(x) {
                    return x.field == nCol.field;
                });
        ...
        TabulatorComponent.prototype.openAddItem = function() {
            this.onAddItem.emit(); // if(this.groupType == 1)
            // {
            //   this.openAddDevice();
            // }
        ...
        __decorate([core_1.Input()], TabulatorComponent.prototype, "parentColName");

        __decorate([core_1.Input()], TabulatorComponent.prototype, "idColName");

        __decorate([core_1.Input()], TabulatorComponent.prototype, "componentName");

        __decorate([core_1.Input()], TabulatorComponent.prototype, "isModal");

        __decorate([core_1.Output()], TabulatorComponent.prototype, "onAddItem");

        __decorate([core_1.Output()], TabulatorComponent.prototype, "onAddGroup");

        __decorate([core_1.Output()], TabulatorComponent.prototype, "onEditItem");

        __decorate([core_1.Output()], TabulatorComponent.prototype, "onDeleteItem");

        __decorate([core_1.Output()], TabulatorComponent.prototype, "onCheckItem");

        __decorate([core_1.Output()], TabulatorComponent.prototype, "onSelectItem");

        __decorate([core_1.Output()], TabulatorComponent.prototype, "onMenuActionSelected");

        __decorate([core_1.Input()], TabulatorComponent.prototype, "showMenuOptions");

        __decorate([core_1.Input()], TabulatorComponent.prototype, "panelId");

        __decorate([core_1.Input()], TabulatorComponent.prototype, "divId");

        __decorate([core_1.Input()], TabulatorComponent.prototype, "direction");

        __decorate([core_1.Input()], TabulatorComponent.prototype, "childRowData");

        __decorate([core_1.Input()], TabulatorComponent.prototype, "groupByList");

        __decorate([core_1.Input()], TabulatorComponent.prototype, "sortByList");

        __decorate([core_1.Output()], TabulatorComponent.prototype, "onItemDoubleClick");

        __decorate([core_1.Output()], TabulatorComponent.prototype, "onSearchTextChange");

        __decorate([core_1.Input()], TabulatorComponent.prototype, "searchFilters");

        __decorate([core_1.Output()], TabulatorComponent.prototype, "onShowGridFilterChange");

        __decorate([core_1.Input()], TabulatorComponent.prototype, "groupType");

        __decorate([core_1.Input()], TabulatorComponent.prototype, "path");

        __decorate([core_1.ViewChild("searchInput")], TabulatorComponent.prototype, "searchInput");

        __decorate([core_1.ViewChild("searchButton")], TabulatorComponent.prototype, "searchButton");

        __decorate([core_1.Input()], TabulatorComponent.prototype, "decreaseHeight");

        __decorate([core_1.Input()], TabulatorComponent.prototype, "columnSettings");

        TabulatorComponent = __decorate([core_1.Component({
