...
import { SettingMenuShowOptions } from '../../../../core/view-models/setting-menu-show-options';
import * as Tabulator from 'tabulator-tables/dist/js/tabulator';
import { PanelSetting } from '../../../../core/models/panel-setting';
...
export class TabulatorComponent implements OnInit, OnChanges, AfterViewInit, OnDestroy, AfterContentInit {
  ...
  @Input() decreaseHeight: string = '550';
  height: string = "100%"

  customStyle: string = `padding-left: 0px; padding-top: 0px;display: block;position: absolute;`;
  ...
  private drawTable() {
    ...
    Tabulator.prototype.extendModule("export", "formatters", {
      pdfMake: {
        defaultConfig: {
          // Other PDF export configuration options...
          fonts: {
            normal: this.arabicFont,
            bold: this.arabicFont,
            italics: this.arabicFont,
            bolditalics: this.arabicFont,
          },
        },
      },
    });
    let tableDiv = document.getElementById('my-tabular-table' + this.divId);
    if (tableDiv) {
      tableDiv.innerHTML = '';
      setTimeout(() => {
  ...
  newColumns = [
    ...
    this.lang == "ar" ? {
      title: "اختار",
      field: "", formatter: this.CheckBoxFormatIcon, cellClick: (e, cell) => {
  ...
  getContextMenu(row: any, e: any, menuOptions: SettingMenuShowOptions, scope: any, componentName: any) {
    ...
    if (menuOptions.showEdit) {
      menu.push(scope.getContextMenuItem(row, componentName,
        "Edit", "../../../assets/sniper/images/dropdown_edit.svg", this.translate.transform("general.edit")));
    }
    if (menuOptions.showDisplay) {

      menu.push(scope.getContextMenuItem(row, componentName,
        "Display", "../../../assets/sniper/images/dropdown_edit.svg", this.translate.transform("general.display")));
    }
    if (menuOptions.showActivate) {

      menu.push(scope.getContextMenuItem(row, componentName,
        "Activate", "../../../assets/sniper/images/check_icon.svg", this.translate.transform("general.activate")));
    }
    if (menuOptions.showDelete) {
      menu.push(scope.getContextMenuItem(row, componentName,
        "Delete", "../../../assets/sniper/images/delete_blue.svg", this.translate.transform("general.delete")));
    }
    ...
    if (menuOptions.showUserGroup) {
      menu.push(scope.getContextMenuItem(row, componentName,
        "UserGroups", "../../../assets/sniper/images/dropdown_folder.svg", this.translate.transform("general.user-groups")));
    }


    if (menuOptions.showUserDevice) {
      menu.push(scope.getContextMenuItem(row, componentName,
        "UserDevices", "../../../assets/sniper/images/dropdown_device.svg", this.translate.transform("general.user-devices")));
    }
    ...
    if (menuOptions.showUserNotification) {
      menu.push(scope.getContextMenuItem(row, componentName,
        "UserNotifications", "../../../assets/sniper/images/dropdown_notification.svg", this.translate.transform("general.user-notifications")));
    }
    ...
    if (menuOptions.showDetermineTheTechnician) {
      ...
      menu.push(scope.getContextMenuItem(row, componentName,
        "DetermineTheTechnician", "../../../assets/sniper/images/dropdown_edit.svg", this.translate.transform("general.detemine-technician")));
    }
    if (menuOptions.showRequestDetails) {

      menu.push(scope.getContextMenuItem(row, componentName,
        "RequestDetails", "../../../assets/sniper/images/dropdown_edit.svg", this.translate.transform("general.request-details")));
    }
    let maintenanceRequestState = row._row.data.requestStatus;
    if (maintenanceRequestState != null) {
      if (maintenanceRequestState == 3 || maintenanceRequestState == 4 || maintenanceRequestState == 5 || maintenanceRequestState == 6) {
        if (menuOptions.showProductReceipt) {
          ...
          menu.push(scope.getContextMenuItem(row, componentName,
            "ProductReceipt", "../../../assets/sniper/images/dropdown_edit.svg", this.translate.transform("general.product-receipt")));
        }
      }
      if (maintenanceRequestState == 3 || maintenanceRequestState == 4) {
        if (menuOptions.showPriceRequest) {
          ...
          menu.push(scope.getContextMenuItem(row, componentName,
            "PriceRequest", "../../../assets/sniper/images/dropdown_edit.svg", this.translate.transform("general.price-request")));
        }
      }
      if (maintenanceRequestState != 8) {
        if (menuOptions.showCloseRequest) {
          ...
          menu.push(scope.getContextMenuItem(row, componentName,
            "CloseRequest", "../../../assets/sniper/images/dropdown_edit.svg", this.translate.transform("general.close-request")));
        }
      }
    }

    let contractStatus = row._row.data.contractStatus;

    if (contractStatus != null) {

      if (contractStatus == 0 || contractStatus == 5 || contractStatus == 7) {
        if (menuOptions.showEditContract) {

          menu.push(scope.getContextMenuItem(row, componentName,
            "EditContract", "../../../assets/sniper/images/dropdown_edit.svg", this.translate.transform("buttons.edit")));
        }
      }
      ...
      if (contractStatus == 0 || contractStatus == 5) {
        if (menuOptions.showIssueContract) {
          ...
          menu.push(scope.getContextMenuItem(row, componentName,
            "IssueContract", "../../../assets/sniper/images/dropdown_edit.svg", this.translate.transform("rent-contracts.IssueContract")));
        }
      }
      if (contractStatus == 8 && row._row.data.isRenew != true) {
        if (menuOptions.showRenewContract) {
          ...
          menu.push(scope.getContextMenuItem(row, componentName,
            "RenewContract", "../../../assets/sniper/images/dropdown_edit.svg", this.translate.transform("rent-contracts.renew-contract")));
        }
      }
      if (contractStatus != 0 && contractStatus != 7 && contractStatus != 3 && contractStatus != 4) {
        if (menuOptions.showSettlementContract) {
          menu.push(scope.getContextMenuItem(row, componentName,
            "SettlementContract", "../../../assets/sniper/images/dropdown_edit.svg", this.translate.transform("rent-contracts.settlement-contract")));
        }
      }
      if (contractStatus == 3 || contractStatus == 4) {
        if (menuOptions.showSettlementDisplayContract) {
          menu.push(scope.getContextMenuItem(row, componentName,
            "SettlementDetailsContract", "../../../assets/sniper/images/dropdown_edit.svg", this.translate.transform("rent-contracts.display-settlement")));
        }
      }
      // if (contractStatus != 0 && contractStatus != 5 && contractStatus != 7) {
      //   if (menuOptions.showDisplayContract) {
      //     menu.push(scope.getContextMenuItem(row, componentName,
      //       "DisplayContract", "../../../assets/sniper/images/dropdown_edit.svg", this.translate.transform("general.display")));
      //     }
      // }
    }
    if (menuOptions.showPrint) {
      ...
      menu.push(scope.getContextMenuItem(row, componentName,
        "Print", "../../../assets/sniper/images/dropdown_edit.svg", this.translate.transform("general.print")));
    }
  ...
  getContextMenuItem(row: any, componentName: any, actionName: any, iconUrl: any, actionTranslate?: any) {
    return {
