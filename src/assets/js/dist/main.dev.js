...
function mainFunction() {
  ...
  $("#menu-toggle,.icon-set,.cross-circle").click(function (e) {
    e.preventDefault();
    $(".logo-name, .menus, .list-group, .sidebar-heading,#sidebar-wrapper,#page-content-wrapper").toggleClass("toggled"); //sidebar-wrapper
  });
